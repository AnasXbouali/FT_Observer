...
```math
u_{1}(\hat I,\hat S,\hat\theta_1,\hat\theta_2):=
\begin{cases}
1-\dfrac{S_h}{\hat S},
& \text{if } \hat I \geq I^*(\hat\theta_1,\hat\theta_2,Q) \text{ and } \hat S>S_h,\\[6pt]
0, & \text{otherwise}.
\end{cases}
```
...
```math
\widetilde u_{1}(\hat I,\hat S,\hat\theta_1,\hat\theta_2):=
\begin{cases}
1-\dfrac{S_h}{\hat S}\dfrac{I^*(\hat\theta_1,\hat\theta_2,Q)}{\hat I},
& \begin{aligned}
  \text{if } \hat I \geq I^*(\hat\theta_1,\hat\theta_2,Q) \\
  \text{and } \hat S > S_h,
\end{aligned} \\[8pt]
0, & \text{otherwise}.
\end{cases}
